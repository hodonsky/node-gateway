...
const requestTransformer = async ( ctx, requestPipe = [] ) => {
  console.log( "requestTransformer" )
  return requestPipe && requestPipe.length > 0
          ? await requestPipe.reduce( async ( result, fn ) => await fn( result ? result : ctx ), null )
...
export const actionHandler = ( {
  ...
  console.log( "rqT", requestTransformers )
  console.log( "rsT", responseTransformers )
